...
fail=0
for t in core particle rigidbody collision resolution stacking features harmonics sph leaf convex articulation contacts2 softbody constraint2 query robotics advanced ros compound em; do
